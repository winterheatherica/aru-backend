...
type History struct {
	...
	TableHeaders []string   `gorm:"column:table_headers;type:text[]" json:"table_headers,omitempty"`
	TableRows    [][]string `gorm:"column:table_rows;type:text[][]" json:"table_rows,omitempty"`
